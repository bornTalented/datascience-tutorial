...
> 
> * **Scree Plot:** Plot the eigenvalues in descending order. Look for an "elbow" point where the explained variance starts to level off. Components before the elbow are typically retained.
