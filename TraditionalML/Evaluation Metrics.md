...
3. Recall (Sensitivity, True Positive Rate): Proportion of actual positives correctly identified.
...
9. **False Positive Rate (FPR)**: Proportion of actual negatives incorrectly classified as positive (false alarm rate).
